...
# ============================================================
# Recovery Insights with complete data
# ============================================================
...
@patch("app.recovery_insights.get_active_goals")
...
def test_build_recovery_insights_with_full_data(
    ...
    """
    Recovery Insights should combine current recovery state,
    goals, recent check-ins, and saved review snapshots.
    """
    ...
    mock_active_goals.return_value = [
        {
            "id": 1,
            "status": "active",
        }
    ...
    assert "Active Recovery Goals: 1" in result
...
# ============================================================
# Recovery Insights with missing history
# ============================================================
...
def test_build_recovery_insights_handles_missing_history(
    ...
    """
    Recovery Insights should remain useful when optional historical
    ...
    assert "Current Step: 1" in result
    assert "Open Step Assignments: 0" in result
    assert "Active Recovery Goals: 0" in result
