...
void main() {
  ...
  testWidgets(
    'recent check-in AI requires confirmation and shows reflection',
    (tester) async {
        ...
        if (request.method == 'POST' &&
          ...
          return http.Response(
            jsonEncode({
              'checkin_count': 3,
              'reflection':
                  'Recovery contact has been visible recently.',
            }),
            200,
          );
        }
  ...
  testWidgets(
    'cancelling recent check-in AI sends nothing',
    (tester) async {
      var aiRequestCount = 0;
